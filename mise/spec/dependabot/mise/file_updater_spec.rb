...
RSpec.describe Dependabot::Mise::FileUpdater do
  ...
  describe "#updated_dependency_files" do
    ...
    context "with inline table format" do
      ...
      it "preserves the other inline table fields" do
        expect(updated_files.first.content).to include('virtualenv = ".venv"')
      end
    end
    ...
    context "with table header format" do
      ...
      it "updates the version in a table header entry" do
        expect(updated_files.first.content).to include('version = "1.22.0"')
      end

      it "preserves the table header" do
    ...
    context "with inline table format where version is not first" do
      ...
      it "preserves other inline table fields" do
        expect(updated_files.first.content).to include('virtualenv = ".venv"')
      end
    end
    ...
    context "with table header format where version is not first" do
      ...
      it "preserves other keys in the table" do
        expect(updated_files.first.content).to include('env = "production"')
      end
